...
public class UserListServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			List<Map<String,Object>> list = don.getByFilter("yhb","sf!='I'",null,null,String.valueOf(pageno),null);
			List<Map<String,Object>> tlist = don.getByFilter("yhb", "sf!='I'", null, null, null,null);
